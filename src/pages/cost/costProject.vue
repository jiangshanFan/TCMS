<template>
  <div class="costProject posr">
    ...
    <div class="costProjects pl20 pr20" v-else>
      ...
      <div class="section-search mb20 mt20">
        <el-row>
          ...
          <div class="fl mr20 mb20">
            ...
            <el-input v-model="search.value2" size="mini" clearable style="width:calc(100% - 150px);"></el-input>
          </div>
      ...
      <div class="mt20">
        <!-- 添加 -->
        <el-button type="primary" size="mini" @click="openCostTypeDialog('')" v-if="$route.meta.button.buttons.includes('新增经费类别')">新增经费类别</el-button>
        <el-button type="primary" size="mini" @click="exportExcel" v-if="$route.meta.button.buttons.includes('导出Excel')">导出Excel</el-button>
        ...
        <el-table
          ...
          <el-table-column fixed="right" label="操作" width="unset" align="center">
            <template slot-scope="scope">
              <span>
                <el-button class="underline f12" @click="openCostTypeDialog(scope.row)" type="text" align="center" v-if="$route.meta.button.buttons.includes('预算设置')">预算设置</el-button>
                <el-button class="underline f12" @click="edit(scope.row)" type="text" align="center">编辑</el-button>
                <el-button class="underline f12" @click="deletes(scope.row)" type="text" align="center" v-if="scope.row.autoManual">删除</el-button>
              </span>
            </template>
          </el-table-column>
        </el-table>
      ...
      <!-- 新增经费或预算设置 -->
      <el-dialog :title="Object.keys(costType).length?'预算设置':'新增经费类别'" :visible.sync="costTypeDialogShow" center custom-class="dialogStyle" @close="cancelAdd">
            ...
            <el-col :span="12" :offset="6">
              <el-col>
                <el-form-item label="经费类别：">
                  <el-input v-model="costType.tuitionInformation" autocomplete="off" style="width:100%;"></el-input>
                </el-form-item>
              </el-col>

              <el-col>
                <el-form-item label="资助金额：">
                  <el-input v-model="costType.amountPatronage" autocomplete="off" style="width:100%;"></el-input>
                </el-form-item>
              </el-col>

              <el-col>
                <el-form-item label="自筹金额：">
                  <el-input v-model="costType.raiseMount" autocomplete="off" style="width:100%;"></el-input>
                </el-form-item>
              </el-col>
            </el-col>
          </el-row>
...
/* eslint-disable */
  ...
  export default {
    ...
    methods: {
      ...
      deletes(row) {
        this.$confirm(`此操作将删除"${row.tuitionInformation}", 是否继续?`, '提示', {
