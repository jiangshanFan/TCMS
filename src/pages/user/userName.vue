      ...
      <div class="section-search mb20 mt20">
        <el-row>
          ...
          <div class="fl mr20 mb20">
            ...
            <el-input v-model="search.userName" size="mini" clearable style="width:calc(100% - 100px);"></el-input>
          </div>
          ...
          <el-table-column fixed="right" label="操作" width="180" align="center">
            <template slot-scope="scope">
              <span v-if="scope.row.userId !== 1">
                ...
                <el-button class="underline f12" @click="resets(scope.row)" type="text" align="center" v-if="$route.meta.button.buttons.includes('重置密码')">重置密码</el-button>
...
/* eslint-disable */
  ...
  export default {
    ...
    methods: {
      ...
      resets(row) {
        this.$confirm(`此操作将重置用户"${row.userName}"密码为"Ybsx#123", 是否继续?`, '提示', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).then(async () => {
    ...
    data() {
      return {
        ...
        breadcrumb: [
          ...
          { id: 'userName', name: '账户管理', path: '/user/userName', thing: 'showDefault'},
        ],
      }
    },
  }
