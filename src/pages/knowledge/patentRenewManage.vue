    ...
    <div class="pl20 pr20">
      ...
      <el-dialog title="填写续费信息" :visible.sync="renewEditVisible" center custom-class="dialogStyle" @close="cancelAdd">
          ...
          <el-row style="line-height:40px;">
            <el-row :gutter="10" >
              ...
              <el-col :span="12">
                <el-form-item label="当前续费次数：">
                  <span>{{renewEdit.renewCount+1}}</span>
                </el-form-item>
              </el-col>

              <el-col :span="12">
                <el-form-item label="最迟续费时间：">
                  <span>{{$format(new Date(renewEdit.latestRenewTime).getTime()).dates}}</span>
                </el-form-item>
              </el-col>
            ...
            <el-row :gutter="10" >
              ...
              <el-col :span="12">
                <el-form-item label="OA单号：">
                  <el-input @blur="downBlur" v-model="renewEdit.oaOddNum" autocomplete="off" style="width:100%;"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="OA单状态：">
                  <!-- <el-input v-model="renewEdit.oaOddNum" autocomplete="off" style="width:100%;"></el-input> -->
                  <span>{{oacondition}}</span>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-col :span="24">
              <el-form-item label="备注：">
                <el-input maxlength="50" :show-word-limit="true" type="textarea" :rows="5" resize="none" placeholder="请输入内容" v-model="renewEdit.remark"></el-input>
              </el-form-item>
            </el-col>
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button @click="renewEditVisible = false" size="mini">取 消</el-button>
        </div>
      </el-dialog>
      <!-- renewList-->
...
/* eslint-disable */
  ...
  /** 导入api.js */
  import { getPatentRenewManageList, exportPatentRenewManageList, getRenewInfoList, insertRenewInfo,queryOfficeAutomationInformation} from '../../axios/api.js'
  ...
  export default {
    ...
    methods: {
      ...
      async downBlur(){
        let res=await queryOfficeAutomationInformation({
          mathCode:this.renewEdit.oaOddNum
        })
        if(res.status===1){
          this.oacondition=res.msg.documentsState
        }
      },
      ...
      add(form) {
        ...
        this.$confirm(`此操作将新增续费信息,请确认信息无误, 是否继续?`, '提示', {
          ...
          let res = await insertRenewInfo({
            oaOddNum:this.renewEdit.oaOddNum,
            remark:this.renewEdit.remark,
            pid:pid,
            latestRenewTime:form.latestRenewTime,
            oaStatus:this.oacondition,
            renewAmount:form.renewAmount,
            renewCount:form.renewCount+1
          });
          if (res.status === 1) {
    ...
    data() {
      return {
        ...
        header: [
          { prop: 'patentApplyNum', label: '专利号', eachWidth: 40},
