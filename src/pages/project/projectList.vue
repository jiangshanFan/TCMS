<template>
  <div class="projectList posr">
    ...
    <projectRelevance v-else-if="showw===1" @ifChange="showDefault"></projectRelevance>
            ...
            <template slot-scope="scope">
              <span>
                ...
                <el-button
                  ...
                  align="center"
                  class="underline f12"
                  @click="gotoR(scope.row)"
                  v-if="$route.meta.button.buttons.includes('关联专利')"
                >专利关联</el-button>
                <!-- <el-button
                  class="underline f12"
...
import projectRelevance from "../project/projectRelevance";
export default {
  name: "projectList",
  components: {
  ...
  methods: {
    gotoR(row) {
      ...
      this.showw = 1;
      this.breadcrumb.push({ id: "editRel", name: "专利关联" });
    },
  ...
  data() {
    return {
      ...
      header: [
        ...
        // { prop: "createTime", label: "项目创建时间", date: 1 },
        {
          prop: "type",
          label: "项目类型",
          change: [
        ...
        { prop: "userName", label: "银宝负责人" },
        { prop: "assignmentCount", label: "任务总数量" },
        // { prop: "techInterfaceDept", label: "科技接口部门" },
        { prop: "projectStartTime", label: "项目计划开始日期", date: 1 },
        { prop: "projectEndTime", label: "项目计划完成日期", date: 1 },
        { prop: "projectAcceptTime", label: "项目验收日期", date: 1 },
        { prop: "actualStartTime", label: "实际开始日期", date: 1 },
        { prop: "actualEndTime", label: "实际完成日期", date: 1 },
        // { prop: "projectCostTotal", label: "项目总预算", number: 1 },
        { prop: "supportAmount", label: "资助资金 单位/万元", number: 1 },
        { prop: "raiseAmount", label: "自筹资金 单位/万元", number: 1 }
