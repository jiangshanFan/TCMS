...
//专利相关--获取专利变更数据
export const getPatentChangeInfoList = data => { return $ajax({ url: process.env.API_HOST + '/patent/getPatentChangeInfoList', method: 'get', params: data, }) };
//专利相关--新增专利变更信息
export const insertPatentChangeInfo = data => { return $ajax({ url: process.env.API_HOST + '/patent/insertPatentChangeInfo', method: 'post', data: data, meta: 1, }) };
//专利相关--编辑专利变更信息
export const updatePatentChangeInfo = data => { return $ajax({ url: process.env.API_HOST + '/patent/updatePatentChangeInfo', method: 'post', data: data, meta: 1, }) };

//专利相关--终止专利
export const getEndPatentList = data => { return $ajax({ url: process.env.API_HOST + '/patent/getEndPatentList', method: 'get', params: data, }) };

//专利相关--获取授权专利列表
export const getAuthorizePatentList = data => { return $ajax({ url: process.env.API_HOST + '/patent/getAuthorizePatentList', method: 'get', params: data, }) };
//专利相关--获取专利状态
export const getPatentStatus = data => { return $ajax({ url: process.env.API_HOST + '/patent/getPatentStatus', method: 'get', params: data, }) };
...
//知识产权管理--交底书文档详情/专利文档详情/论文文档详情
export const getFileList = data => { return $ajax({ url: process.env.API_HOST + '/fileManageInformation/fileManage/getFileList', method: 'get', params: data, }) };
 ...
 */
// 根据OA单号获取OA单状态
export const queryOfficeAutomationInformation = data => { return $ajax({ url: process.env.API_HOST + '/webService/officeAutomation/queryOfficeAutomationInformation', method: 'post', data: data, }) };
 ...
 */
// erp接口列表
export const queryErpDeptList = data => { return $ajax({ url: process.env.API_HOST + '/ErpDept/erpDeptSet/queryErpDeptList', method: 'get', params: data, }) };
// 删除erp接口
export const deleteErpDept = data => { return $ajax({ url: process.env.API_HOST + '/ErpDept/erpDeptSet/deleteErpDept', method: 'get', params: data, }) };
// 新增erp接口
export const insertErpDept = data => { return $ajax({ url: process.env.API_HOST + '/ErpDept/erpDeptSet/insertErpDept', method: 'post', data: data, meta: 1, }) };
// 编辑erp接口
export const updateErpDept = data => { return $ajax({ url: process.env.API_HOST + '/ErpDept/erpDeptSet/updateErpDept', method: 'post', data: data, meta: 1, }) };
/**
 * 专利关联信息
 * 2019.11.25
 */
// 获取关联专利列表
export const queryProjectRelatedPaten = data => { return $ajax({ url: process.env.API_HOST + '/createProject/project/queryProjectRelatedPaten', method: 'get', params: data, }) };
// 专利关联信息删除
export const removePatenRelatedProject = data => { return $ajax({ url: process.env.API_HOST + '/createProject/project/removePatenRelatedProject', method: 'get', params: data, }) };
// 根据专利名称和受理时间，查看相关联的项目
export const queryPatenRelatedProject = data => { return $ajax({ url: process.env.API_HOST + '/createProject/project/queryPatenRelatedProject', method: 'get', params: data, }) };
// 新增项目关联专利
export const addProjectRelatedPaten = data => { return $ajax({ url: process.env.API_HOST + '/createProject/project/addProjectRelatedPaten', method: 'post', data: data, meta: 1, }) };
/**
 * 项目进度（新） 
 * 2019.11.26
 */
// 获取子任务列表
export const getSubprojectList = data => { return $ajax({ url: process.env.API_HOST + '/projectProgress/subproject/getSubprojectList', method: 'get', params: data, }) };
// 新增子项目
export const saveSubproject = data => { return $ajax({ url: process.env.API_HOST + '/projectProgress/subproject/saveSubproject', method: 'post', data: data, meta: 1, }) };
// 修改子项目信息
export const renewalSubproject = data => { return $ajax({ url: process.env.API_HOST + '/projectProgress/subproject/renewalSubproject', method: 'post', data: data, meta: 1, }) };
// 新增任务
export const saveAssignment = data => { return $ajax({ url: process.env.API_HOST + '/projectProgress/assignment/saveAssignment', method: 'post', data: data, meta: 1, }) };
// 获取任务负责人
export const queryProjectMemberAll = data => { return $ajax({ url: process.env.API_HOST + '/projectMember/projectMemberInformation/queryProjectMemberAll', method: 'get', params: data, }) };
// 获取项目进度列表
export const queryProjectProgressList = data => { return $ajax({ url: process.env.API_HOST + '/projectProgress/projectProgress/queryProjectProgressList', method: 'get', params: data, }) };
// 获取项目名称
...
// 任务统计列表
export const queryStatisticsAssignmentCount = data => { return $ajax({ url: process.env.API_HOST + '/projectProgress/assignmentStatistics/queryStatisticsAssignmentCount', method: 'get', params: data, }) };
// 项目成员工时统计
export const queryStatisticsAssignmentMemberCount = data => { return $ajax({ url: process.env.API_HOST + '/projectProgress/assignmentStatistics/queryStatisticsAssignmentMemberCount', method: 'get', params: data, }) };
// 简报
export const queryPowerPointList = data => { return $ajax({ url: process.env.API_HOST + '/projectProgress/assignmentStatistics/queryPowerPointList', method: 'get', params: data, }) };
// 获取项目名称 状态为进行中
export const queryProjectIngName = data => { return $ajax({ url: process.env.API_HOST + '/createProject/project/queryProjectIngName', method: 'get', params: data, }) };
// 获取任务名称
export const getAssignmentList = data => { return $ajax({ url: process.env.API_HOST + '/projectProgress/subproject/getAssignmentList', method: 'get', params: data, }) };
// 修改任务
export const renewalAssignment = data => { return $ajax({ url: process.env.API_HOST + '/projectProgress/assignment/renewalAssignment', method: 'post', data: data, meta: 1, }) };
// 项目统计列表
export const queryProjectStatistics = data => { return $ajax({ url: process.env.API_HOST + '/createProject/project/queryProjectStatistics', method: 'get', params: data, }) };
// 导出项目成员工时统计
export const downloadStatisticsAssignmentMemberCount = data => { return $ajax({ url: process.env.API_HOST + '/projectProgress/export/downloadStatisticsAssignmentMemberCount', method: 'get', params: data,responseType: 'blob' }) };
// 简报导出
export const downloadQueryPowerPointList = data => { return $ajax({ url: process.env.API_HOST + '/excel/export/downloadQueryPowerPointList', method: 'get', params: data,responseType: 'blob' }) };
// 获取项目名称===>项目成员参与项目的状态为进行中的所有项目
export const queryProjectIngByMember = data => { return $ajax({ url: process.env.API_HOST + '/createProject/project/queryProjectIngByMember', method: 'get', params: data,}) };
// 获取项目名称===>项目成员参与项目的状态不为已关闭、已暂停、已完成的所有项目
export const queryProjectByMember = data => { return $ajax({ url: process.env.API_HOST + '/createProject/project/queryProjectByMember', method: 'get', params: data,}) };
 ...
 */
// 新增日志
export const saveLogRecord = data => { return $ajax({ url: process.env.API_HOST + '/LogRecord/logMessage/saveLogRecord', method: 'post', data: data, meta: 1, }) };
// 复制日志
export const copyLogRecord = data => { return $ajax({ url: process.env.API_HOST + '/LogRecord/logMessage/copyLogRecord', method: 'post', data: data, meta: 1, }) };
// 获取日志列表
export const getLogRecordList = data => { return $ajax({ url: process.env.API_HOST + '/LogRecord/logMessage/getLogRecordList', method: 'get', params: data, }) };
// 修改日志
export const updateLogRecord = data => { return $ajax({ url: process.env.API_HOST + '/LogRecord/logMessage/updateLogRecord', method: 'post', data: data, meta: 1, }) };
//  删除日志
export const removeLogRecord = data => { return $ajax({ url: process.env.API_HOST + '/LogRecord/logMessage/removeLogRecord', method: 'post', data: data,}) };
// 任务编辑页面日志接口
export const getLogRecordListByAssignmentId = data => { return $ajax({ url: process.env.API_HOST + '/LogRecord/logMessage/getLogRecordListByAssignmentId', method: 'get', params: data, }) };
...
//变更项目负责人
export const changePersonProject = data => { return $ajax({ url: process.env.API_HOST + '/projectMember/projectMemberInformation/changePersonProject', method: 'post', data: data, meta: 1, }) };
...
/* 2019.11.14  */
// 项目月度成员考评
export const queryAssessmentManagementList = data => { return $ajax({ url: process.env.API_HOST + '/assessment/assessmentManagement/queryAssessmentManagementList', method: 'get', params: data, }) };
// 项目月度成员考评编辑及部长考评编辑
export const updateAssessmentManagement = data => { return $ajax({ url: process.env.API_HOST + '/assessment/assessmentManagement/updateAssessmentManagement', method: 'post', data: data, meta: 1, }) };
// 部长考评
export const queryAssessmentManagementAllList = data => { return $ajax({ url: process.env.API_HOST + '/assessment/assessmentManagement/queryAssessmentManagementAllList', method: 'get', params: data, }) };
/* 部门相关 */
// 获取部门列表
export const queryDepartmentList = data => { return $ajax({ url: process.env.API_HOST + '/department/operation/queryDepartmentList', method: 'get', params: data, }) };
// 项目部门删除
// export const deleteDepartment = data => { return $ajax({ url: process.env.API_HOST + '/department/operation/deleteDepartment', method: 'get', params: data, }) };
// 新增部门
export const insertDepartment = data => { return $ajax({ url: process.env.API_HOST + '/department/operation/insertDepartment', method: 'post', data: data, meta: 1, }) };
// 编辑部门
export const updateDepartment = data => { return $ajax({ url: process.env.API_HOST + '/department/operation/updateDepartment', method: 'post', data: data, meta: 1, }) };
...
// 获取所有部门接口
export const queryProjectAllName = data => { return $ajax({ url: process.env.API_HOST + '/createProject/project/queryProjectAllName', method: 'get', params: data, }) };
// 部门管理列表
export const queryDepartmentListManage = data => { return $ajax({ url: process.env.API_HOST + '/department/operation/queryDepartmentListManage', method: 'get', params: data, }) };
// 部门管理列表1
export const queryDepartmentMaterialManage = data => { return $ajax({ url: process.env.API_HOST + '/department/operation/queryDepartmentMaterialManage', method: 'get', params: data, }) };
